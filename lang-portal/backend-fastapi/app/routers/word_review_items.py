...
@router.post("/word_review_items/", response_model=schemas.WordReviewItems)
...
@router.get("/word_review_items/", response_model=list[schemas.WordReviewItems])
...
@router.get("/word_review_items/{item_id}", response_model=schemas.WordReviewItems)
