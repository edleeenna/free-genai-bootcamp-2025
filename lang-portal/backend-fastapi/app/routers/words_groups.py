...
@router.post("/word-groups/", response_model=schemas.WordGroup)
...
@router.get("/word-groups/", response_model=list[schemas.WordGroup])
...
@router.get("/word-groups/{word_group_id}", response_model=schemas.WordGroup)
